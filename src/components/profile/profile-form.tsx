...
export function ProfileForm({ user }: ProfileFormProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <form action={infoFormAction} className="flex flex-col">
        <Card className="h-full shadow-lg border-border bg-card/85 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardDescription className="text-xs text-muted-foreground">
              Update your public display name associated with your staff account
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="role-static">Assigned Department Role</Label>
              <div className="flex items-center justify-between p-2.5 rounded-xl border border-border bg-muted/40 text-xs">
      ...
      <form action={pwFormAction} className="flex flex-col">
        <Card className="h-full shadow-lg border-border bg-card/85 backdrop-blur-xl">
          <CardHeader>
            <div className="flex items-center gap-2 text-primary font-semibold text-sm">
            ...
            <CardDescription className="text-xs text-muted-foreground">
              Ensure your account uses a secure password verified by Argon2id
            </CardDescription>
          </CardHeader>
